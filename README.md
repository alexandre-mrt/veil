...
- **Loop 5**: a structured review checklist (access control, arithmetic, crypto/identity, cross-protocol, DeFi economics, flash loans, infra/ops, object model, oracle/timing, type safety, persona flows) -- see `docs/loop5-audit-report.md`

### Loop 5 Audit Summary (review passes)
...
**Aggregate: 3 critical (infra), 5 high, 15 medium, 25 low, 20 info -- 68 total findings (deduplicated from review passes)**
...
└── docs/
    ...
    ├── loop5-audit-report.md        # Review pass: multi-pass security review
    ├── tier3-audit-report.md        # Tier 3 compliance audit (review passes)
...
6. **iterative security review** with a structured review checklist (final loop)
