...
// ===========================================================================
// VEIL SPIKE ADDITION (only deviation from upstream Nautilus enclave.move):
// test-only constructor so app tests can verify enclave signatures against a
// key they control. Upstream only creates Enclave<T> via register_enclave,
// which requires a genuine Nitro attestation document — unobtainable for a
// locally generated test key. Production registration path is unchanged.
// ===========================================================================
#[test_only]
