...
- **ZK circuits** (3 Circom circuits): transfer (6,384 R1CS constraints), compliance (5,979), withdraw (1,439) — counts from `snarkjs r1cs info`, last measured 2026-07-27, see `docs/research/BASELINE.md`
