// Vendored, unmodified, from @taceo/circom-lib v0.6.0 (MIT license, see LICENSE
// in this directory). Source: https://github.com/TaceoLabs/taceo-circom-lib
// Round constants (poseidon2_constants.circom) trace to the HorizenLabs
// reference parameter generator: https://github.com/HorizenLabs/poseidon2
// (poseidon2_rust_params.sage), per the sibling @taceo/poseidon2 JS package's
// README. Not authored or re-derived by this repo — see
// docs/research/2026-08-22-poseidon2-hash-swap.md for how it's used here.
pragma circom 2.2.2;
