...
// MOVE CONTRACTS. Mechanically derived from ../compliance.circom by swapping every Poseidon(n)
...
template Compliance(merkleDepth) {
    ...
    // leaf = Poseidon2Hash(4, userSecret, kycLevel, expiryEpoch, issuerId)
    ...
    component merkleProof = MerkleProofP2(merkleDepth);
    ...
    // nullifier = Poseidon2Hash(5, userSecret, contextId)
    ...
    // contextId = Poseidon2Hash(6, transferNullifier, userSecret)
