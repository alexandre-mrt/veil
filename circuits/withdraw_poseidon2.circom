...
// POSEIDON2 VARIANT — research circuit, not deployed. Identical to withdraw.circom
// except the recipientHash (C9) uses Poseidon2 instead of circomlib Poseidon.
// See docs/research/2026-09-19-poseidon2-merkle-swap.md.
pragma circom 2.1.0;

include "node_modules/circomlib/circuits/poseidon.circom";
include "templates/poseidon2_bn254_t3.circom";
...
template Withdraw() {
    ...
    component recipHash = Poseidon2Hash2to1();
    recipHash.in[0] <== 8;
