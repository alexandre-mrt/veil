...
// Vendored verbatim from @taceo/circom-lib 0.6.0 (MIT, LICENSE-taceo in this directory),
// https://github.com/TaceoLabs/taceo-circom-lib — the Poseidon2 permutation there is pulled
// from TACEO's audited https://github.com/TaceoLabs/oprf-circom/ repo. Not part of Veil's
// live protocol circuits; used only by the research/ benchmark in this directory. See
// docs/research/2026-08-19-poseidon2-arity-benchmark.md for the correctness cross-check
// against an independent implementation (@zkpassport/poseidon2) before trusting these numbers.
