pragma circom 2.1.0;
// POSEIDON2 VARIANT — research circuit, not deployed. Identical to compliance.circom
// except the credential Merkle membership proof (C2) uses Poseidon2 instead of
// circomlib Poseidon for its sibling hash. See
